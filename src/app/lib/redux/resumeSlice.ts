  ...
  reducers: {
    ...
    changeWorkExperiences: (
      ...
      if (field === "descriptions") {
        ...
        workExperience[field] = value as string; // Cast explicitly to string
      }
    },
    changeEducations: (
      draft,
      ...
      if (field === "descriptions") {
        ...
        education[field] = value as string; // Cast explicitly to string
      }
    },
    changeProjects: (
      draft,
      ...
      if (field === "descriptions") {
        ...
        project[field] = value as string; // Cast explicitly to string
      }
    },
    changeSkills: (
      draft,
