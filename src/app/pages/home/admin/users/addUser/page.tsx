      ...
      return (
        <div className="min-h-[calc(100vh-200px)] flex items-center justify-center bg-gray-100 py-8">
          ...
          <div className="bg-white p-12 rounded-xl shadow-2xl w-full max-w-lg">
            <h2 className="text-3xl font-bold text-center mb-8">Add a New User</h2>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button
                type="submit"
                className="w-full py-3 mt-8 text-lg bg-orange-400 text-white rounded-lg hover:bg-orange-500 transition-colors duration-300"
              >
               Add
              </button>
            </form>
